...
/***************** Test code ***************/
unsigned char num_of_courses_user1 = 0;
unsigned int num_of_users_DB = 0;
unsigned int num_of_courses_DB = 0;
unsigned int num_of_users_firstCourse = 0;
...
void DBM_CheckReservations()
{
	...
	for (course_id = 0; course_id < MAX_COURSES; course_id++)
	{
		...
		/******** Test code **********/
		num_of_courses_DB++;
		num_of_users_firstCourse = ListofCourse[course_id].NumberOfEnrolledStudents;
